...
T = lambda p, q, r: True
F = lambda p, q, r: False
P = lambda p, q, r: p
Q = lambda p, q, r: q
R = lambda p, q, r: r

NOT = lambda f1: lambda p, q, r: not f1(p, q, r)
OR = lambda f1, f2: lambda p, q, r: f1(p, q, r) or f2(p, q, r)
AND = lambda f1, f2: lambda p, q, r: f1(p, q, r) and f2(p, q, r)
IMPLIES = lambda f1, f2: lambda p, q, r: not (f1(p, q, r) and not f2(p, q, r))
CIMPLIES = lambda f1, f2: IMPLIES(f2, f1)
XOR = lambda f1, f2: lambda p, q, r: (f1(p, q, r) and f2(p, q, r)) or (not f1(p, q, r) and not f2(p, q, r))
